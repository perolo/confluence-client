...
func (c *ConfluenceClient) GetProjects() (results *SonarProjects) {
	var path string
...
func (c *ConfluenceClient) GetQualityGateByProject(key string) (results *QualityGateType) {
	var path string
...
func (c *ConfluenceClient) GetProjectStatus(key string) (results *ProjectStatusType) {
	var path string
	path = fmt.Sprintf("/api/qualitygates/project_status?projectKey=%s", key)
